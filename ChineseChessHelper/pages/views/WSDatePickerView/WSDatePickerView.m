...
// home indicator
#define bottom_height (isiPhoneX ? 44.f : 10.f)
...
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView *)pickerView
{
    switch (self.datePickerStyle) {
        case DateStyleShowYearMonthDayHourMinute:
            [self addLabelWithName:@[@"年".localized,@"月".localized,@"日".localized,@"时".localized,@"分".localized]];
            return 5;
        case DateStyleShowMonthDayHourMinute:
            [self addLabelWithName:@[@"月".localized,@"日".localized,@"时".localized,@"分".localized]];
            return 4;
        case DateStyleShowYearMonthDay:
            [self addLabelWithName:@[@"年".localized,@"月".localized,@"日".localized]];
            return 3;
        case DateStyleShowYearMonth:
            [self addLabelWithName:@[@"年".localized,@"月".localized]];
            return 2;
        case DateStyleShowMonthDay:
            [self addLabelWithName:@[@"月".localized,@"日".localized]];
            return 2;
        case DateStyleShowHourMinute:
            [self addLabelWithName:@[@"时".localized,@"分".localized]];
            return 2;
        case DateStyleShowYear:
            [self addLabelWithName:@[@"年".localized]];
            return 1;
        case DateStyleShowMonth:
            [self addLabelWithName:@[@"月".localized]];
            return 1;
        case DateStyleShowDayHourMinute:
            [self addLabelWithName:@[@"日".localized,@"时".localized,@"分".localized]];
            return 3;
        default:
            return 0;
    }
    ...
    switch (self.datePickerStyle) {
        ...
        case DateStyleShowYearMonth:{
            if (component == 0) {
                yearIndex = row;
                self.showYearView.text =_yearArray[yearIndex];
                DLog(@"yearIndex = %ld",row);
            }
            if (component == 1) {
                monthIndex = row;
                DLog(@"monthIndex = %ld",row);
            }
        }
            break;
        case DateStyleShowMonthDayHourMinute:{
